...
var (
	...
	ErrActionTooManyOptions        = errors.New("too many options for action provided")
	ErrActionTriggerTooManyOptions = errors.New("too many options for action trigger provided")
